...
useEffect(() => {
  ...
  return (
    <div className={`nav ${show && 'nav_black'}`}>
      ...
      <img className='nav_logo' src="https://mpng.subpng.com/20180629/eoe/kisspng-netflix-streaming-media-television-show-logo-netflix-logo-5b35b03b7c9120.2418554915302451795102.jpg" alt="" srcSet="" />
